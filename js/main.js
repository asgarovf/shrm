window.jQuery(document).ready(function ($) {
  ...
  jQuery(document).ready(function ($) {
    ...
    $("#header .navbar-default li.subnav ul").after(
      '<div class="nav__expand"><i class="fas fa-chevron-down"></i></div>'
    );
    $("#header .navbar-default li.subnav .nav__expand").on(
      "click",
      function () {
  ...
  $("#contact-us-form").submit(function () {
    ...
    form.find(".required-field").each(function () {
      ...
      if ($.trim($(this).val()) === "") {
        $(this)
          .addClass("not-valid")
          .parent()
          .append('<div class="error-msg">This is a required field.</div>');
        hasError = true;
        ...
        if (!emailReg.test($.trim($(this).val()))) {
          $(this)
            ...
            .parent()
            .append(
              '<div class="error-msg">You entered an invalid Email.</div>'
            );
          hasError = true;
        }
      }
    ...
    if (!hasError) {
      ...
      $.post("contact-process.php", formData, function (data) {
        ...
        form.append(
          '<div class="success-msg">Thank you! We will contact you shortly.</div>'
        );
      }).fail(function () {
        //form.find('.required-field').val('');
        form.append(
          '<div class="error-msg">Error occurred. Please try again later.</div>'
        );
      });
    }
    return false;
